...
export default function ShoppingCart() {
  ...
  return (
    <div
      className={`z-40 bg-white flex flex-col absolute right-3 md:right-80 top-14 w-80 py-4 px-4 shadow-[0_5px_15px_0_rgba(0,0,0,.15)] rounded-md transition-opacity duration-500 ${
